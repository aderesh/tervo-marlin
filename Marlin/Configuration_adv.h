...
#define AD_LEVEL_X1_POS 17
#define AD_LEVEL_X2_POS 262

#define AD_LEVEL_Y1_POS 34
#define AD_LEVEL_Y2_POS 267

#define AD_LEVEL_Z_POS 0
#define AD_LEVEL_Z_TRAVEL_POS 10
...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_1_DESC "LF"
  #define MAIN_MENU_ITEM_1_GCODE "G0 Z" STRINGIFY(AD_LEVEL_Z_TRAVEL_POS) "\nG0 X" STRINGIFY(AD_LEVEL_X1_POS) " Y" STRINGIFY(AD_LEVEL_Y1_POS) " \nG0 Z" STRINGIFY(AD_LEVEL_Z_POS)

  #define MAIN_MENU_ITEM_2_DESC "RF"
  #define MAIN_MENU_ITEM_2_GCODE "G0 Z" STRINGIFY(AD_LEVEL_Z_TRAVEL_POS) "\nG0 X" STRINGIFY(AD_LEVEL_X2_POS) " Y" STRINGIFY(AD_LEVEL_Y1_POS) " \nG0 Z" STRINGIFY(AD_LEVEL_Z_POS)

  #define MAIN_MENU_ITEM_3_DESC "RB"
  #define MAIN_MENU_ITEM_3_GCODE "G0 Z" STRINGIFY(AD_LEVEL_Z_TRAVEL_POS) "\nG0 X" STRINGIFY(AD_LEVEL_X2_POS) " Y" STRINGIFY(AD_LEVEL_Y2_POS) " \nG0 Z" STRINGIFY(AD_LEVEL_Z_POS)

  #define MAIN_MENU_ITEM_4_DESC "RL"
  #define MAIN_MENU_ITEM_4_GCODE "G0 Z" STRINGIFY(AD_LEVEL_Z_TRAVEL_POS) "\nG0 X" STRINGIFY(AD_LEVEL_X1_POS) " Y" STRINGIFY(AD_LEVEL_Y2_POS) " \nG0 Z" STRINGIFY(AD_LEVEL_Z_POS)

  #define MAIN_MENU_ITEM_5_DESC "Preheat for " PREHEAT_1_LABEL
